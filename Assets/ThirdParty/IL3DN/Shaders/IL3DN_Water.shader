	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float foamEdge280 = ( 1.0 - step( (0.1 + (_TimeParameters.y - -1.0) * (0.3 - 0.1) / (1.0 - -1.0)) , edgeEffect208 ) );
				...
				float2 uv0241 = IN.ase_texcoord7.xy * temp_output_347_0 + temp_cast_1;
				float2 temp_cast_2 = (( 1.0 - mulTime242 )).xx;
				float2 uv0364 = IN.ase_texcoord7.xy * temp_output_347_0 + temp_cast_2;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 temp_output_252_0 = (WorldPosition).xz;
				float2 panner253 = ( 0.1 * _Time.y * float2( 1,0 ) + temp_output_252_0);
				float simplePerlin2D244 = snoise( ( panner253 * 2.5 ) );
				float2 panner292 = ( 0.1 * _Time.y * float2( -1,0 ) + temp_output_252_0);
				float simplePerlin2D290 = snoise( ( panner292 * 2 ) );
				float clampResult294 = clamp( ( simplePerlin2D244 + simplePerlin2D290 ) , 0.0 , 1.0 );
				float largeNoisePattern297 = clampResult294*0.5;
				float4 screenPos = IN.ase_texcoord2;
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float eyeDepth1 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float edgeEffect208 = abs( ( eyeDepth1 - screenPos.w ) *3 );
				float foamWater218 = ( 1.0 - step( largeNoisePattern297 , edgeEffect208 ) );
				float foamEdge280 = ((1.0 - step((0.1 + (_TimeParameters.y + 0.1) * 0.03), edgeEffect208)) * 1);
				float topWater237 = saturate( ( 1.0 - edgeEffect208 ) );
				float deepWater170 = saturate( pow( edgeEffect208 , abs( _WaterFalloff ) ) );
				float4 lerpResult13 = lerp( _BottomColor , _MidColor , deepWater170);
...
/*ASEBEGIN
Version=18000
1413;366;1924;1065;219.3884;913.1025;1.3;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;213;462.6745,-40.76108;Float;False;Property;_Transparency;Transparency;4;0;Create;True;0;0;False;0;0;1;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;238;478.2904,-964.1451;Inherit;True;Property;_Normal;Normal;0;2;[NoScaleOffset];[Normal];Create;True;0;0;False;0;-1;None;76738900a2dcf084990de478555ec33c;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;0.25;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;239;451.0338,-283.6268;Float;False;Property;_Smoothness;Smoothness;5;0;Create;True;0;0;False;0;1;5;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;362;471.4243,-643.7675;Inherit;True;Property;_Normal02;Normal 02;0;3;[HideInInspector];[NoScaleOffset];[Normal];Create;True;0;0;False;0;-1;None;None;True;0;True;bump;Auto;True;Instance;238;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;0.25;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;377;1400.875,-772.275;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;3;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;2;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;True;True;True;True;True;0;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;375;1400.875,-772.275;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;3;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;True;False;False;False;False;0;False;-1;False;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;373;1410.875,-773.275;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;IL3DN/Water;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;14;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;0;True;2;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;14;Workflow;1;Surface;1;  Refraction Model;0;  Blend;0;Two Sided;1;Cast Shadows;1;Receive Shadows;0;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;Vertex Position,InvertActionOnDeselection;1;0;6;False;True;True;True;True;True;False;;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;376;1400.875,-772.275;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;3;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;True;2;False;-1;False;False;False;False;False;True;1;LightMode=Meta;False;0;Hidden/InternalErrorShader;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;374;1400.875,-772.275;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;3;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;0;Hidden/InternalErrorShader;0;0;Standard;0;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;379;1410.875,-773.275;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;0;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;True;0;False;-1;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;0;False;0;Hidden/InternalErrorShader;0;0;Standard;0;0
...
ASEEND*/
//CHKSM=6247D5662DEB67EAC5BA90D0C99BFA16FE5C43DB