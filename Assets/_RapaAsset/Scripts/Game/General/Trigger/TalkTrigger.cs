...
public class TalkTrigger : MonoBehaviour
{
    ...
    public void ShowTalk()
    {
        ...
        if (OverrideKey)
            UI_Talk.Instance.SetInputThisTime(OverrideInputKB, GameManager.Instance.ControllerSprites.GetSprit(GameInput.JoystickBrandType, OverrideInputJoy), OverrideAction);
