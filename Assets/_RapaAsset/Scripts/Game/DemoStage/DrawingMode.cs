...
public class DrawingMode : UnitySingleton_D<DrawingMode>
{
    ...
    public void EndDrawingMode()
    {
        ...
        IEnumerator delay()
        {
            ...
            {
                questTutorial = false;
                UI_Talk.Instance.SetInputThisTime(menuIconKB, GameManager.Instance.ControllerSprites.GetSprit(GameInput.ControllerType, ControllerButton.Up), Actions.Menu);
